...
docker image tag graalvm:java17-${TAG_VERSION} ${CI_REGISTRY}/opcal/graalvm:java17-${GRAALVM_VERSION}-${TIMESTAMP}
...
docker push ${CI_REGISTRY}/opcal/graalvm:java17-${GRAALVM_VERSION}-${TIMESTAMP}
...
docker rmi -f ${CI_REGISTRY}/opcal/graalvm:java17-${GRAALVM_VERSION}-${TIMESTAMP}
